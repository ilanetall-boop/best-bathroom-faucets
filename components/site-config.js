/**
 * site-config.js — Best Bathroom Faucets
...
window.SITE_CONFIG = {
  ...
  footer: {
    description: "Your trusted source for bathroom faucet reviews, comparisons, and buying guides. Find the perfect faucet for style, durability, and value.",
    quickLinks: [
    ...
    network: [
      ...
      { label: "Best Bathroom Storage", href: "https://best-bathroom-storage.com" }
    ]
  },
  networkBanners: [
    {
    ...
    {
      id: "best-towel-warmers",
      domain: "best-towel-warmers.com",
      headline: "Want Warm, Cozy Towels?",
      description: "Expert reviews of the best towel warmers — from freestanding to wall-mounted luxury designs.",
      ctaText: "Browse Towel Warmers",
      active: true
    },
    {
